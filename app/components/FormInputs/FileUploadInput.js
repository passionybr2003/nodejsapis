      ...
      if (this.readyState === 4) {
        ...
        try {
          ...
          if (
            resData &&
            resData.files &&
            resData.files.length > 0 &&
            resData.files[0].location
          ) {
  ...
  const thumbs = files.map((file) => (
    <div style={thumb} key={file.name}>
      <div style={thumbInner}>
        <img src={file.preview} style={img} alt="Uploaded File Thumbnail" />
      </div>
    </div>
  ));
              ...
              {props.fileType === 'image' ? (
                ...
                <div>
                  <div style={baseStyleForText}>
                    ...
                    >
                      <Grid item xs={7}>
                        <div style={customStyles.textDiv}>
                          {selectedFileName}
                        </div>
                      </Grid>
                      <Grid item xs={2}></Grid>
